...
class SpiritualAiService {
  Future<SpiritualAiReply> ask({
    ...
    if (retriever.wantsRestrictedSources(trimmed)) {
      askMessage =
          '$askMessage\n\n(Համակարգ. նախ հստակ պատասխանիր հարցին, հետո տուր լիարժեք, բովանդակալից պատասխան ըստ աղբյուրների՝ առանձին պարբերություններով։ Միայն Դալլասի մեկնություններից, Հին Կտակարանի մշակութային-պատմական մեկնությունից, Քիների Նոր Կտակարանի մեկնությունից և Սուրբ Հայրերի Էկզեգետ մեկնություններից։ Յուրաքանչյուր պարբերությունում նշիր աղբյուրը հայերենով։ Եթե անձ է՝ ժամանակ, վայր, դեր, իրադարձություններ։ Եթե գիրք է՝ հեղինակ, ում համար է գրվել և ինչու։ Եթե մեկնություն է՝ լիարժեք բացատրիր։ Կարճ մի գրիր։ Վիքիպեդիա արգելված է։ Եթե չկա, ասա որ այս աղբյուրներում չկա։ Անգլերեն բառ մի գրիր։)';
