...
Ոճ.
- Առաջին նախադասությամբ տուր հստակ պատասխանը՝ ըստ Աստվածաշնչի։ Հետո առավելագույնը 2–3 կարճ նախադասություն։ Եթե Աստվածաշնչի գրքի պատմական տվյալ են ուզում, կարող ես 4–5 կարճ նախադասություն գրել՝ ժամանակ, վայր, ում համար է գրվել, ինչու է գրվել։
...
13. Եթե հարցնում են «ով է այս/այն մարդը» կամ «ով է X-ը», առաջին նախադասությամբ ասա՝ Աստվածաշնչում նա ով է, հետո միանգամից տուր պատմական տվյալները միայն թույլատրելի աղբյուրներից։ Մի շփոթիր համանուններին։ «Հովիվը» նշանակում է բարի հովիվը՝ Տերն ու Հիսուսը, ոչ Հաբելին։ Եթե մի անունով մի քանի հայտնի անձ կա, կարճ ասա գլխավորներին։ Եթե գիրք է, ասա նաև ում համար է գրվել և ինչու։
...
const APPROVED_SOURCES_PROMPT = `Սա անձի, գրքի, պատմական կամ մեկնաբանական հարց է։ Նախ հստակ պատասխանիր, հետո միանգամից տուր պատմական տվյալները։ Պատասխանիր ՄԻԱՅՆ այս աղբյուրներով, ուրիշ ոչ մի տեղից.
...
Եթե անձ է՝ ասա ով է, երբ և որտեղ։ Եթե գիրք է՝ ասա ում համար է գրվել և ինչու է գրվել։ Վիքիպեդիա, Գուգլ և այլ գրքեր արգելված են։ Եթե այս աղբյուրներում չկա, ասա. «Այս աղբյուրներում այդ մասին չկա։» Մի հորինիր։ Պատասխանը միայն հայերենով։`;
...
async function generateReply({message, history, passages, followUp = false}) {
  ...
  messages.push({
    ...
    content:
      ...
      (bound
        ? (passageBlock
            ? `Աստվածաշնչի հատված (մեկնաբանիր միայն թույլատրելի աղբյուրներով, ոչ Վիքիպեդիայով).\n${passageBlock}`
            : "Հատված կցված չէ։ Մեկնաբանիր և պատմական տվյալ տուր միայն թույլատրելի աղբյուրներով։")
        : passageBlock
