...
const APPROVED_SOURCES_PROMPT = `Սա պատմական կամ մեկնաբանական հարց է։ Պատասխանիր ՄԻԱՅՆ այս աղբյուրներով, ուրիշ ոչ մի տեղից.
...
Վիքիպեդիա, Գուգլ և այլ գրքեր արգելված են։ Եթե այս աղբյուրներում չկա, ասա. «Այս աղբյուրներում այդ մասին չկա։» Մի հորինիր։ Պատասխանը միայն հայերենով։`;
