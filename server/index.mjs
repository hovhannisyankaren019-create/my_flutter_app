...
function sanitizeOffTopicReply(text) {
  ...
  const refusal =
    t.includes("չեմ կարող") ||
    t.includes("չեմ պատասխան") ||
    t.includes("կապ չունի") ||
    t.includes("միայն աստվածաշնչյան հարց") ||
    t.includes("միայն աստվածաշնչի");
  if (!refusal) return raw;
